...
Пытался сделать всё синхронно, но где-то сваливается в асинхронность.
...
Обработка пользователей по таблице users1 закончена. 3507 записей
Работаем с задачами
Обработка задач по таблице tasks1 закончена. 3367 записей
```
